...
import { openItemLocation, openItemPrice, openItemSituation } from "../menu";
export default function Aside() {
  return El({
    element: "div",
    className:
      "grid col-span-12 xl:col-start-1 xl:col-end-2 pr-1  lg:fixed lg:w-[280px]  2xl:w-[300px] ml-2",
    //className:" pr-1  lg:fixed w-[300px]",
    child: [
      El({
        element: "div",
              ...
              El({
                ...
                child: [
                  ...
                  El({
                    element: "div",
                    className:
                      "flex flex-col absolute top-6 right-4 text-slate-400",
                    child: [
                      El({
                        element: "span",
                        className: "",
      ...
      El({
        ...
        child: [
          El({
            element: "div",
            className:
              " grid grid-cols-3  justify-start  text-sm text-slate-400",
            id: "",
            child: [
              linkMenu({
                title: "درباره دیوار",
